...
class Myorder extends Pupmart_Controller
{
  ...
  {
    $data['title'] = "Dafter Order";
    $data['content'] = $this->myorder->where('id_user', $this->id)->orderBy('date', 'DESC')->getAll();
    $data['page'] = 'myorder/index';
